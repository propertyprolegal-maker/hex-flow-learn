...
const HeroBackground = () => {
  ...
  useEffect(() => {
    ...
    const initWaves = () => {
      waves = [
        { y: canvas.height * 0.6, amplitude: 50, frequency: 0.003, speed: 0.02, offset: 0, color: 'rgba(20, 184, 166, 0.08)' },
        { y: canvas.height * 0.7, amplitude: 40, frequency: 0.004, speed: 0.025, offset: 100, color: 'rgba(139, 92, 246, 0.06)' },
        { y: canvas.height * 0.8, amplitude: 30, frequency: 0.005, speed: 0.03, offset: 200, color: 'rgba(20, 184, 166, 0.04)' },
      ];
    };
