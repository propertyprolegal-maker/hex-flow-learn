        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Click on any course to view curriculum, pricing, and enroll.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {courses.map((course) => (
              <button
                ...
                className={`group relative glass-card rounded-xl overflow-hidden border transition-all duration-500 hover:-translate-y-2 text-left ${
